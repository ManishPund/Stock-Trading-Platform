...
const Hero = () => {
  return (
    <section className="px-d-lg-block5 my-5">
      <div className="heading text-center mb-5 ">
        <h1 className="fs-3 lh-base">
          We pioneered the discount broking model in India. <br /> Now, we are
          breaking ground with our technology.
        </h1>
      </div>
      <div className="row p-2 p-lg-5 my-5 lh-lg border-top">
        <div className="col-12 col-lg  py-5 px-lg-4">
          <p>
